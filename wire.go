...
func InitUserController(grpcConn *grpc.ClientConn, fileGRPCConn *file_repo.FileGRPCClientConn, db *mongo.Database, conn *amqp.Connection) user_deliv.UserController {
	wire.Build(
